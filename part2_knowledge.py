...
all_symbols = ["SaraHasKey", "LinaHasKey", "LinaSeenNearRoom", "LinaIsGuilty", "NoraHasKey", "NoraIsGuilty"]
...
kb.tell(Implication(nora_key, nora_guilty))  # If Nora has a key, Lina is NOT guilty
...
print(f"Nora is guilty: {answer3}")